export default function Footer() {
  return (
    <footer
      className="relative z-10 border-t border-neon-cyan/10 bg-navy-900/80 backdrop-blur-md"
      id="contact"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              ...
              <br />A 3-day college tech festival.
            </p>
          </div>

          {/* Quick links */}
          <div>
            <h4 className="font-orbitron text-sm font-semibold text-slate-200 mb-3 tracking-wider">
              QUICK LINKS
            </h4>
          ...
          <div>
            ...
            <div className="mt-4">
              <h5 className="font-orbitron text-xs font-semibold text-slate-300 tracking-wider mb-2">
                FOR INQUIRIES
              </h5>
